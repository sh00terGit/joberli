...
class AdOrder
{
     ...
     * Add task
     *
     * @param \Core\AdBundle\Entity\AdTask $task
     *
     * @return AdOrder
     */
    ...
    public function getDaysLeft() {
        $finishDate = $this->adoptDate;
        $finishDate->add(new DateInterval('P' . $this->getExecutDaysAmount() . 'D'));

        $days = date_diff($finishDate, $this->adoptDate)->days;
        return $days;
